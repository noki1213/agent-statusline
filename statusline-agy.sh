...
touch "$1" # Update the timestamp (prevents duplicate launches)
...
# ---------- Auto model detection (primary/secondary assignment) ----------
...
# Line 6 (secondary model, compact one-line display)
line6=""
